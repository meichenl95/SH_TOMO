...
#                if plot == 'True' :
                    ...
                    if normalize == 'True':
                        ...
                        if (len(norm)>len(average)):
                            norm = norm[0:len(average)]
...
def main():
    ...
    filename = "s40rts_nocrust_10s.-115.35.675"
    readxh(ax=ax,filename=filename,dirname=dirname,odirname=current_path,plot='True',align_index=9,phase='S',yy_index=6,ylabel='Distance (deg)',cut_b=250,cut_a=100,ofile='{}.pdf'.format(filename),normalize='True',color_seism='black',dt=0.063)
