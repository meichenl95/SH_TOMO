...
def main():
    ...
    for target_depth in np.arange(10,1001,5):
        ...
        readbinary(filename=filename,dirname='{}/results_all_deg2_win5_dis_ttcorr'.format(dirname),savepath=curpath,evt=evt,seismnum=seismnum,minseismnum=minseismnum,target_depth=target_depth,average_or_root=average_or_root)
