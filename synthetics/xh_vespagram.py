...
def main():
    ...
    path = '/home/meichen/work1/SH_TOMO/synthetics/XH_files/vesp_S40RTS_NOCRUST_10s'
    current_path = '/home/meichen/Research/SH_TOMO/synthetics'
    
    dirname = '{}'.format(path)
    filename = "s40rts.no020501.vesp.west"
    readvespaxh(filename=filename,dirname=dirname,odirname=current_path,NPTS=11111,samplingrate=0.063)
